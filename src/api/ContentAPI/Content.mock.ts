...
export const getContentMock = () => {
  return request<ContentDTO>({
    ...
    links: {
      thumbnail: { href: '/authoring/v1/resources/9a069bfa086cfe1ae7c98e789fec1c58' },
      retire: { href: '/authoring/v1/changes/content/db4930e9-7504-4d9d-ae6c-33facca754d1/status/retire' },
      draft: { href: '/authoring/v1/content/db4930e9-7504-4d9d-ae6c-33facca754d1:draft' },
      self: { href: '/authoring/v1/content/db4930e9-7504-4d9d-ae6c-33facca754d1' },
